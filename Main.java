...
public class Main {
    ...
    static final Path[] paths = new Path[]{Paths.get("data/accounts.txt"), Paths.get("data/transactions.txt")};
    static final AccountRepository accountRepository = new AccountRepository();
    static final CheckingService checkingService = new CheckingService(accountRepository);
    static final CreditService creditService = new CreditService(accountRepository);
